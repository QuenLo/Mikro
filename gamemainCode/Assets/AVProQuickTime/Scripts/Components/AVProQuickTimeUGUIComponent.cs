...
[AddComponentMenu("AVPro QuickTime/uGUI Movie")]
public class AVProQuickTimeUGUIComponent : UnityEngine.UI.MaskableGraphic
{
	[SerializeField]
	public AVProQuickTimeMovie m_movie;
	...
	protected AVProQuickTimeUGUIComponent()
	{ }
	...
	/// Texture to be used.
	/// </summary>
	public AVProQuickTimeMovie texture
	{
		get
		{
			return m_movie;
